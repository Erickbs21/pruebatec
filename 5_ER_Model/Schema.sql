...
CREATE TABLE PROMOCION_SUCURSAL (
    ...
    CONSTRAINT PK_PromoSucursal PRIMARY KEY (ID_Promocion, ID_Sucursal),
    CONSTRAINT FK_PromoSucursal_Promo FOREIGN KEY (ID_Promocion) REFERENCES PROMOCION(ID_Promocion),
    CONSTRAINT FK_PromoSucursal_Sucursal FOREIGN KEY (ID_Sucursal) REFERENCES SUCURSAL(ID_Sucursal)
);
